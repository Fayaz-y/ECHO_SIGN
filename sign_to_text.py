...
class Application:
    ...
    def __init__(self):
       ...
       # header = tk.Label(self.root, text="My Application Header", font=("Arial", 16, "bold"), 
       #           bg="blue", fg="white", width=200, height=4)  # Width in characters, height in lines
       # header.pack()
        header_frame = tk.Frame(self.root, bg="blue", height=80)
        header_frame.pack(fill="x")

# Load the logo (Ensure the image path is correct)
        logo_image = Image.open("logo.png")  # Replace with your image path
        logo_image = logo_image.resize((40, 40))  # Resize image
...
# Create Label for Name
        name_label = tk.Label(header_frame, text="ECHO_SIGN", font=("Montserratt", 30, "bold"), bg="blue", fg="white")
        name_label.pack(side="left", padx=10)
        
        self.T = tk.Label(self.root, text="Sign Language To Text Conversion", font=("Courier", 30, "bold"), bg="#f0f0f0")
        self.T.pack(pady=10)
        

        
        self.panel = tk.Label(self.root, bg="white", relief="solid", bd=2)
        self.panel.place(x=250, y=170, width=400, height=400)
        
        self.panel2 = tk.Label(self.root, bg="white", relief="solid", bd=2)
        self.panel2.place(x=850, y=190, width=300, height=300)
        
        self.T1 = tk.Label(self.root, text="Character:", font=("Courier", 25, "bold"), bg="#f0f0f0")
        self.T1.place(x=10, y=580)
        self.panel3 = tk.Label(self.root, font=("Courier", 25), bg="white", relief="solid", width=10)
        self.panel3.place(x=250, y=580)
        
        self.T3 = tk.Label(self.root, text="Sentence:", font=("Courier", 25, "bold"), bg="#f0f0f0")
        self.T3.place(x=10, y=632)
        self.panel5 = tk.Label(self.root, font=("Courier", 25), bg="white", relief="solid", width=30, anchor="w")
        self.panel5.place(x=250, y=632)
        
        self.T4 = tk.Label(self.root, text="Suggestions:", fg="red", font=("Courier", 25, "bold"), bg="#f0f0f0")
        self.T4.place(x=10, y=680)
        
        button_style = {"font": ("Courier", 18), "width": 10, "height": 1, "bg": "#d9d9d9", "relief": "raised"}
        
        self.b1 = tk.Button(self.root, **button_style)
        self.b1.place(x=390, y=700)
        
        self.b2 = tk.Button(self.root, **button_style)
        self.b2.place(x=590, y=700)
        
        self.b3 = tk.Button(self.root, **button_style)
        self.b3.place(x=790, y=700)
        
        self.b4 = tk.Button(self.root, **button_style)
        self.b4.place(x=990, y=700)
        
        self.speak = tk.Button(self.root, text="Speak", font=("Courier", 20), width=8, command=self.speak_fun, bg="#a0d468")
        self.speak.place(x=1155, y=630)
        
        self.clear = tk.Button(self.root, text="Clear", font=("Courier", 20), width=8, command=self.clear_fun, bg="#ed5565")
        self.clear.place(x=1305, y=630)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("D:\KPR_Hackathon\ECHO_SIGN\white.jpg")
                # img_final=img_final1=img_final2=0
